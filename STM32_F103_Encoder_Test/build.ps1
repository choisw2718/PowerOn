...
$projectName = "STM32_F103_Encoder_Test"
...
$startupObject = Join-Path $build "startup_stm32f103rb.o"
$mainObject = Join-Path $build "main.o"
$syscallsObject = Join-Path $build "syscalls.o"
...
Remove-Item -LiteralPath $startupObject, $mainObject, $syscallsObject -Force

Write-Host "Encoder test build complete:"
Write-Host "  BIN: $bin"
Write-Host "  HEX: $hex"
Write-Host "  ELF: $elf"
Write-Host "Flash: powershell -ExecutionPolicy Bypass -File STM32_F103_Encoder_Test\flash.ps1"
